...
interface BlueprintListState {
    ...
    showDeploymentWizardModal: boolean;
    blueprintId: string;
...
export default class BlueprintList extends React.Component<BlueprintListProps, BlueprintListState> {
    ...
    createDeployment: BlueprintsViewProps['onCreateDeployment'] = item => {
        console.log("onCreateDeployment");
    ...
    hideDeploymentModal = () => {
        this.setState({ showDeploymentModal: false, showDeploymentWizardModal:false });
    };
    ...
    render() {
        ...
        // const { DeployBlueprintModalWizard } = DeployBlueprintModalWizard;
        ...
        return (
            <div>
                ...
                <BlueprintsView
                    ...
                    onCreateDeploymentWizard={this.createDeploymentWizard}
